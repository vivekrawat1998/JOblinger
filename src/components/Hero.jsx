...
const Hero = () => {
  ...
  return (
    <div className='w-full grid-place-items-center '>
      <div className='font-poppins max-w-[85vw] mx-auto flex flex-col  md:flex-row justify-between items-center px-6 md:px-20 w-full md:min-h-screen bg-[#f6faff]'>
        ...
        <div className='max-w-2xl space-y-6 pt-16 md:pt-0 z-10 mt-10'>
          ...
          <div className="text-sm mt-4 text-gray-700">
            ...
            <a href="#" className="text-blue-600 underline mx-1">Designer</a>
            <a href="#" className="text-blue-600 underline mx-1">Web</a>
            <a href="#" className="text-blue-600 underline mx-1">IOS</a>
            <a href="#" className="text-blue-600 underline mx-1">Developer</a>
            <a href="#" className="text-blue-600 underline mx-1">PHP</a>
            <a href="#" className="text-blue-600 underline mx-1">Senior</a>
            <a href="#" className="text-blue-600 underline mx-1">Engineer</a>
          </div>
        </div>
